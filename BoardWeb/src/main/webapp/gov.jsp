...
<body>
  ...
  <script>
    let url =
      'https://api.odcloud.kr/api/15077586/v1/centers?page=1&perPage=284&serviceKey=zkkl%2FP4fRpXPR6IvmvB11TwaRQ2twkWct32PGzCjQ%2Fl56OPaK4dcJIqpvtZTz7PKaN7R2gdCY84L%2B0z3YXYYlg%3D%3D';
    let centerList = [];
